...
public class MonetaryAmountParameterizedType implements UserType, ParameterizedType{
...
DDL schema generation.
	...
	public void setParameterValues(Properties parameters) {
		convertTo = parameters.getProperty("convertTo");
		System.out.println("convertTo: " + convertTo);
	}
