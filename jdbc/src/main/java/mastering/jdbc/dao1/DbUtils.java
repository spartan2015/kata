...
/*public class DBUtils
{
    ...
    {
        *//*
         * In dieser Map werden s�mtliche Datenbank relevanten Information gespeichert. Der Zugriff erfolgt nur �ber die Methoden
        ...
        *//*
         * Liefert das ThreadInformation Objekt f�r den currentThread. Existiert kein ThreadInfo Objekt, dann wird eines erzeugt.
         *//*
        ...
        *//*
         * Liefert das ThreadInformation Objekt f�r aThread. Existiert kein ThreadInfo Objekt, dann wird eines erzeugt.
         *//*
