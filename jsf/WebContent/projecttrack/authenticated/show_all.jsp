...
<f:view>
	...
	<h:form>
		...
		<h:panelGrid columns="1" cellpadding="5">
			<f:facet name="header">
				<h:outputText value="All projects"></h:outputText>				
			</f:facet>
			
			
			<h:messages globalOnly="true"></h:messages>
			
			<h:dataTable binding="#{inbox.allProjects}" rowClasses="row1,row2" var="project">
				...
				<h:column>
					<f:facet name="header">
						<h:commandLink actionListener="#{inbox.sort}">
							...
							<f:param name="column" value="waiting"/>
						</h:commandLink>
					</f:facet>
					<h:outputText value="${project.status.rol}" />
				</h:column>
