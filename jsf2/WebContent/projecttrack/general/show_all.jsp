...
<f:view>
	<head>
		...
		<link rel="styleshee" type="text/css" href="<c:out value="${pageContext.request.contextPath}"/>/css/style.css" />
	</head>
	...
	<h:form>
		<h:panelGrid columns="1">
			...
			<h:dataTable binding="#{inboxBean.projectTable}" var="project" value="#{inboxBean.allProjects}">
				<h:column>
					<f:facet name="header">
